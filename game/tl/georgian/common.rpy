# TODO: Translation updated at 2021-04-22 21:32

translate georgian strings:
    ...
    new "დარწმუნებული ხართ რომ გამოსვლა გინდათ?"

    # renpy/common/00gui.rpy:379
    old "Are you sure you want to return to the main menu?\nThis will lose unsaved progress."
    new "დარწმუნებული ხართ რომ მთავარ მენიუში გინდათ გადასვლა?\nპროგრესი დაიკარგება."
    ...
    new "ვერ მოხდა სქრინშოთის შენახვა როგორც %s."

    # renpy/common/00keymap.rpy:312
    old "Saved screenshot as %s."
    new "სქრინშოთი შენახულია როგორც %s."
    ...
    new "პროგრამა შეიცავს უფასო პროგრამას რამდენიმე ლიცენზიის ქვეშ, როგორიცაა MIT-ის ლიცენზია და GNU Lesser General Public ლიცენზია."
